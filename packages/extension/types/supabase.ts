    ...
    Tables: {
      error_logs: {
        Row: {
          ...
          error_type: string
          id: number
          interaction: Database["public"]["Enums"]["user_interaction_type"]
      ...
      user_settings: {
        Row: {
          ...
          writing_niche: Database["public"]["Enums"]["writing_niche_type"]
        }
        Insert: {
          updated_at?: string
          user_id: string
      ...
      weekly_digests: {
        Row: {
          ...
          sent_at: string | null
          status: Database["public"]["Enums"]["digest_status_type"]
          user_id: string
        }
        Insert: {
          digest_content?: Json | null
